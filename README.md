...
### 短期
- [ ] 非遗技艺扩展到 20+ 种，覆盖更多地域和类别
- [ ] 知识图谱自动化构建——从文档中自动抽取实体和关系
- [ ] 流式输出（SSE），改善长回答体验
- [ ] 多语言支持（中/英/日），服务海外非遗研究

### 中期
- [ ] 图文混合检索——支持非遗工艺图片的检索与展示
- [ ] 传承人访谈录音转写与知识抽取
- [ ] 社区协作编辑——允许非遗研究者补充和修正知识
- [ ] 辩论引擎升级——支持 3+ Agent 的多方辩论

### 长期
- [ ] 非遗知识图谱的开放 API，供第三方应用调用
- [ ] VR/AR 集成——非遗技艺的虚拟展示和教学
- [ ] 与博物馆/文化机构的数据对接
- [ ] 本地模型部署，减少对在线 API 依赖
